...
function start_page_navi( $before = '', $after = '' ) {
	...
	echo '<li>';
	next_posts_link( __( 'Next', 'start' ), 0 );
	echo '</li>';
	if ( $end_page < $max_page ) {
		$last_page_text = __( 'Last', 'start' );
